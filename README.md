...
### Exercise 5
---
In this exercise we have created a new python script to integrate all previous exercises in a class. As all exercises have a continuity, we have only includes in the class exercises 2 and 3. The user is able to choose between performin ex2 or ex3. With these two options, the user is able to apply all the concepts in all exercises. Testing the class, we have checked that it performs exactly the same as in ex2 and ex3. You can find the script in ex5 folder. 
